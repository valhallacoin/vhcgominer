...
#
# Windows gominer requires nvml.dll and valhallacoin.dll to reside in the same
...
ifeq ($(ARCH),Msys)
obj/valhallacoin.dll: obj sph/blake.c valhallacoin.cu
	$(NVCC) --shared --optimize=3 --compiler-options=-GS-,-MD -I. -Isph valhallacoin.cu sph/blake.c -o obj/valhallacoin.dll
else
obj/valhallacoin.a: obj sph/blake.c valhallacoin.cu
	$(NVCC) --lib --optimize=3 -I. valhallacoin.cu sph/blake.c -o obj/valhallacoin.a
endif

ifeq ($(ARCH),Msys)
build: obj/valhallacoin.dll
else
build: obj/valhallacoin.a
endif
	go build -tags 'cuda'

ifeq ($(ARCH),Msys)
install: obj/valhallacoin.dll
else
install: obj/valhallacoin.a
endif
